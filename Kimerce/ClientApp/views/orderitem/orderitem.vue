      ...
      <div class="card">
        <div class="card-header card-header-flex">
          <div class="d-flex flex-column justify-content-center mr-auto">
            <h6 class="mb-0">Danh sách orderitem</h6>
          </div>
          <div class="d-flex flex-column justify-content-center">
            <router-link :to="{path:'/orderitem/createorupdate/0'}">
            ...
            <a-table :columns="columns" :dataSource="arr" :scroll="{ x: '100%' }" bordered>
              <span slot="action" slot-scope="text, record">
                ...
                <a-button type="dashed">
                  <router-link :to="{ name: 'orderitemcreateorupdate', params: { id: record.id }}"><a-icon type="edit" /></router-link>
                </a-button>
...
<script>
  ...
  const columns = [
    ...
    {
      title: 'productPieceId',
      dataIndex: 'productPieceId',
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        del(id) {
          if (confirm(" delete?")) {
            ...
            axios.delete('https://localhost:44397/Orderitems/Delete/' + id).then(res => {
      ...
      LoadData() {
        ...
        console.log(params);
        this.$http.post('https://localhost:44397/Orderitems/search', params).then(r => {
