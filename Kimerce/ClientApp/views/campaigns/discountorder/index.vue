      ...
      <div class="card">
        <div class="card-header card-header-flex">
          ...
          <div class="d-flex flex-column justify-content-center">
            <router-link :to="{path:'/discountorder/create'}">
            ...
            <a-table :columns="columns" :dataSource="arr" :scroll="{ x: '100%' }" bordered>
              <span slot="action" slot-scope="text, record">
                ...
                <a-button type="dashed">
                  <router-link :to="{path:'discountorder/edit/' + record.id}"><a-icon type="edit" /></router-link>
                </a-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      del(id) {
        if (confirm(" delete?")) {
          axios.delete('https://localhost:44397/DiscountOrder/Delete/' + id).then(res => {
          });
      ...
      LoadData() {
        ...
        console.log(params);
        this.$http.post('https://localhost:44397/DiscountOrder/Search', params).then(r => {
