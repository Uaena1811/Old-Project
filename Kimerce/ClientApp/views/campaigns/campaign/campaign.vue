      ...
      <div class="card">
        <div class="card-header card-header-flex">
          ...
          <div class="d-flex flex-column justify-content-center">
            <router-link to="/campaign/createorupdate/0">
          ...
          <div class="air__utils__scrollTable">
            <a-table :columns="Columns"
              ...
              <span slot="action" slot-scope="record">
                <router-link :to="{path:'/campaign/createorupdate/' + record.id}" class="btn btn-sm btn-primary mr-2">
                  <a-icon type="edit" />
                  Sửa
                </router-link>
                ...
                <router-link :to="{path:'/campaign/details/' + record.id}" class="btn btn-sm btn-primary mr-2">
                  <a-icon type="edit" />
                  Thông tin
                </router-link>
              </span>
  ...
  export default {
    ...
    methods: {
      ...
      LoadData() {
        ...
        console.log(params);
        axios.post('https://localhost:44397/Campaign/search', params).then(r => {
      ...
      DeleteProduct(id) {
        if (confirm("Có thật sự muốn xóa?")) {
          axios.delete('https://localhost:44397/Campaign/delete/' + id).then(response => {
