...
<script>
  ...
  export default {
    ...
    mounted() {
      var self = this;
      axios.get('https://localhost:44397/CampaignOrder/GetById/' + this.$route.params.id)
        .then(function (res) {
          self.CampaignOrder = res.data;
          console.log('done', self.CampaignOrder);
        })
