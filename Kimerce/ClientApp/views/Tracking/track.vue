    ...
    <div class="card">
      <div class="card-header card-header-flex">
        ...
        <div class="d-flex flex-column justify-content-center">
          <router-link to="/Tracking/create" class="btn btn-primary">
            Create
          </router-link>
        </div>
      </div>
            ...
            <template slot="action" slot-scope="text, record">
              <a-tooltip placement="top">
                ...
                <a-button type="dashed">
                  <router-link :to="{ name: 'trackedit', params: { id: record.id }}"><a-icon type="edit" /></router-link>
                </a-button>
              </a-tooltip>
              <a-tooltip placement="top">
                <template slot="title">
                ...
                <a-button type="danger">
                  <router-link :to="{name:'trackdel', params:{id: record.id}}"><a-icon type="delete" /></router-link>
                </a-button>
              </a-tooltip>
            </template>
          </a-table>
...
<script>
  ...
  const columns = [
    ...
    {
      title: 'EntityId',
      scopedSlots: { customRender: 'entityId' },
    },

    {
      title: 'EntityType',
      scopedSlots: { customRender: 'entityType' },
    },
  ...
  export default {
    ...
    methods: {
      ...
      get() {
        axios.post("https://localhost:44397/Tracking/Search/",
          {
            "Pagination": {
              "From": 0,
              "PageIndex": 1,
