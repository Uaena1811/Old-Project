        ...
        <div class="air__utils__scrollTable">
          <a-table :columns="Columns"
            ...
            <span slot="action" slot-scope="record">
              <a-button class="btn btn-sm btn-primary mr-2" @click="AddProductImage(record.id)" icon="plus">
                Thêm
              </a-button>
            </span>
  ...
  export default {
    ...
    methods: {
      ...
      LoadData() {
        ...
        console.log(params);
        axios.post('https://localhost:44397/images/search', params).then(r => {
      ...
      AddProductImage(id) {
        this.addForm.imageId = id;
        axios.post(ProductImageApi.createOrUpdate, this.addForm).then(response => {
