      ...
      <div class="card">
        <div class="card-header card-header-flex">
          <div class="d-flex flex-column justify-content-center">
            <router-link to="/productcategory/createorupdate/0">
          ...
          <div class="air__utils__scrollTable">
            <a-table :columns="Columns"
              ...
              <span slot="action" slot-scope="record">
                <router-link :to="{path:'/productcategory/createorupdate/' + record.id}">
            ...
            <a-pagination class="ant-pagination ant-table-pagination"
  ...
  export default {
        ...
        Columns: [
          {
            ...
            title: "Phân khúc giá",
            dataIndex: 'priceRanges',
          }, {
            title: "Danh sách phân trang mặc định",
    ...
    methods: {
      ...
      LoadData() {
        ...
        console.log(params);
        axios.post(ProductCategoryApi.list, params).then(r => {
      ...
      DeleteProduct(id) {
        if (confirm("Có thật sự muốn xóa?")) {
          axios.delete(ProductCategoryApi.delete + id).then(response => {
