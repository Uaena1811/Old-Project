  ...
  <a-spin tip="Đang tải..." :spinning="IsLoading">
    <a-row>
      ...
      <div class="air__utils__heading">
        <h5>Quản lý nhà cung cấp email</h5>
      </div>
      ...
      <div class="card">
        <div class="card-header card-header-flex">
          <div class="d-flex flex-column justify-content-center mr-auto">
            <h6 class="mb-0">Danh sách nhà cung cấp email</h6>
          </div>
          <div class="d-flex flex-column justify-content-center">
            <router-link to="/emailprovider/createorupdate/0">
          ...
          <div class="air__utils__scrollTable">
            <a-table :columns="Columns"
              ...
              <span slot="action" slot-scope="record">
                <router-link :to="{path:'/emailprovider/createorupdate/' + record.id}" class="btn btn-sm btn-primary mr-2">
                  <a-icon type="edit" />
                  Sửa
                </router-link>
...
<script>
  ...
  import EmailProviderApi from './api';
  ...
  export default {
    ...
    methods: {
        ...
        return {
          ...
          Search: {
            PredicateObject: {
              ...
              CreatedStart: this.FrmSearch.getFieldValue('CreatedTime').length > 0 ? moment(this.FrmSearch.getFieldValue('CreatedTime')[0]).format() : null,
              CreatedEnd: this.FrmSearch.getFieldValue('CreatedTime').length > 0 ? moment(this.FrmSearch.getFieldValue('CreatedTime')[1]).format() : null,
            }
          }
        }
      },
      LoadData() {
        ...
        console.log(params);
        axios.post(EmailProviderApi.list, params).then(r => {
      ...
      DeleteProduct(id) {
        if (confirm("Có thật sự muốn xóa?")) {
          axios.delete(EmailProviderApi.delete + id).then(response => {
