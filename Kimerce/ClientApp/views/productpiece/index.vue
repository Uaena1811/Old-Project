      ...
      <div class="card">
        <div class="card-header card-header-flex">
          <div class="d-flex flex-column justify-content-center">
            <router-link to="/productpiece/createorupdate/0">
          ...
          <div class="air__utils__scrollTable">
            <a-table :columns="Columns"
              ...
              <span slot="action" slot-scope="record">
                <router-link :to="{path:'/productpiece/createorupdate/' + record.id}">
  ...
  export default {
    ...
    data() {
      return {
        ...
        Columns: [
          ...
          {
            title: 'Mã thuộc tính tồn kho',
            dataIndex: 'inventoryAttributeId',
          },
          {
            title: 'Mã giá trị thuộc tính',
    ...
    methods: {
      ...
      LoadData() {
        ...
        console.log(params);
        axios.post(ProductPieceApi.list, params).then(r => {
      ...
      DeleteProduct(id) {
        if (confirm("Có thật sự muốn xóa?")) {
          axios.delete(ProductPieceApi.delete + id).then(response => {
