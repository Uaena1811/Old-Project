  ...
  <a-spin tip="Đang tải..." :spinning="IsLoading">
    <a-row>
      ...
      <div class="air__utils__heading">
        <h5>Quản lý giá trị thuộc tính sản phẩm</h5>
      </div>
      ...
      <div class="card">
        <div class="card-header card-header-flex">
          <div class="d-flex flex-column justify-content-center">
            <router-link to="/attributevalue/createorupdate/0">
          ...
          <div class="air__utils__scrollTable">
            <a-table :columns="Columns"
              ...
              <span slot="action" slot-scope="record">
                <router-link :to="{path:'/attributevalue/createorupdate/' + record.id}">
...
<script>
  ...
  import AttributeValueApi from './api';
  ...
  export default {
    ...
    methods: {
      ...
      LoadData() {
        ...
        console.log(params);
        axios.post(AttributeValueApi.list, params).then(r => {
      ...
      DeleteProduct(id) {
        if (confirm("Có thật sự muốn xóa?")) {
          axios.delete(AttributeValueApi.delete + id).then(response => {
