<template>
  <div>
    <div :class="{air__sidebar: true, air__sidebar__toggled: settings.isSidebarOpen}">
      <vue-custom-scrollbar :style="{ height: '100%' }">
        <div class="air__sidebar__inner">
          <a href="javascript: void(0);"
             class="fe fe-x-circle air__sidebar__close"
             @click="toggleSidebar()" />
          <h5>
                  ...
                  <div class="col-6">
                    <div class="mb-2">
                      <a-radio :value="'default'"
                               :disabled="settings.menuLayoutType !== 'left'">Default</a-radio>
                    </div>
                    <div class="mb-2">
                      <a-radio :value="'flyout'"
                               :disabled="settings.menuLayoutType !== 'left'">Flyout</a-radio>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="mb-2">
                      <a-radio :value="'compact'"
                               :disabled="settings.menuLayoutType !== 'left'">Compact</a-radio>
                    </div>
                  </div>
                </div>
              </a-radio-group>
          ...
          <div :class="$style.air__sidebar__type" class="mb-4">
            ...
            <div :class="$style.air__sidebar__type__items">
              <a-select :defaultValue="settings.routerAnimation"
                        style="width: 100%;"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isMenuCollapsed"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isMenuUnfixed"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isTopbarFixed"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isFooterDark"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <air-color-picker :value="settings.menuColor"
                                :setting="'menuColor'"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <air-color-picker :value="settings.flyoutMenuColor"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <air-color-picker :value="settings.systemLayoutColor"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isContentNoMaxWidth"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isAppMaxWidth"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isGrayBackground"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isGrayTopbar"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isSquaredBorders"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isCardShadow"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isBorderless"
          ...
          <div :class="$style.air__sidebar__item">
            ...
            <div :class="$style.air__sidebar__container">
              <a-switch :checked="settings.isMenuShadow"
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      console.log(this.settings.isSidebarOpen);
    },
  }
</script>
